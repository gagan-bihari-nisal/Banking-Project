...
import com.bms.loanservice.exceptions.BadLoanException;
...
public class GlobalExceptionControllerAdvice {
	...
	@ExceptionHandler(BadLoanException.class)
	public ResponseEntity<?> handleBadProfileException(BadLoanException exp) {
		Map<String, String> map = new HashMap<>();
