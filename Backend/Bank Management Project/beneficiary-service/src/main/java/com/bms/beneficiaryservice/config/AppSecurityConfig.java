package com.bms.beneficiaryservice.config;
...
import com.bms.beneficiaryservice.filter.TokenValidatorFilter;
...
public class AppSecurityConfig {
	...
	SecurityFilterChain defaultConfig(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/addbeneficiary").authenticated().anyRequest().permitAll();
